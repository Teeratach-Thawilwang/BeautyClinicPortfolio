...
const statusChoices = [
  {label: 'Active', value: CustomerCourseStatus.Active},
  {label: 'Compelete', value: CustomerCourseStatus.Completed},
  {label: 'Expired', value: CustomerCourseStatus.Expired},
]
    ...
    <>
      ...
      <BottomSheet ref={buttonSheetRef}>
        ...
        <View style={styles.filterItemContainer}>
          <Text style={styles.filterItemLabel}>สถานะ</Text>
          <ButtonChoice
